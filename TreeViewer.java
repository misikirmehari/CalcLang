...
public class TreeViewer extends Basic {
	...
	// The noide class must be done before using the tree viewer class
	...
	public TreeViewer(String title, int ulx, int uly, int pw, int ph, Node tree) {
		super(title, ulx, uly, pw, ph);

		setBackgroundColor(new Color(128, 128, 200));

		// tree display
		cameras.add(new Camera(25, 45, pw - 55, ph - 75, 0, 10, 0, 5, new Color(200, 200, 200)));
